...
{
	static float input[conv2d_32_in_height][conv2d_32_in_width][conv2d_32_in_channels];
	static float conv_32_weights[conv2d_32_filter_height][conv2d_32_filter_width][conv2d_32_in_channels][conv2d_32_num_filters];
	static float conv_32_biases[conv2d_32_num_filters];
	static float conv_32_feature_map[conv2d_32_out_height][conv2d_32_out_width][conv2d_32_out_channels];
	/*********** Get input ***********/
	...
	for( int y = 0 ; y < conv2d_32_filter_height ; y++ )
		for ( int x = 0 ; x < conv2d_32_filter_width ; x++ )
			for ( int channel = 0 ; channel < conv2d_32_in_channels ; channel++ )
