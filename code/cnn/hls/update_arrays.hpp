...
#pragma HLS PIPELINE off
				l0_conv_weights[h][w][f] -= lr * l0_conv_weight_grad[h][w][f];
				l0_conv_weight_grad[h][w][f] = 0.f;
			}
}

void update_l0_conv_biases ( float lr ,
	...
	float l0_conv_biases[l0_conv_f] )
{
	...
	{
#pragma HLS PIPELINE off
		l0_conv_biases[f] -= lr * l0_conv_bias_grad[f];
		l0_conv_bias_grad[f] = 0.f;
	}
}
void update_l2_conv_weights ( float lr , 
...
#pragma HLS PIPELINE II=11
					float temp = lr * l2_conv_weight_grad[h][w][c][f];
...
void update_l2_conv_biases ( float lr ,
	...
	float l2_conv_biases[l2_conv_f] )
{
	...
	{
#pragma HLS PIPELINE off
		l2_conv_biases[f] -= lr * l2_conv_bias_grad[f];
		l2_conv_bias_grad[f] = 0.f;
	}
}

void update_l4_dens_weights ( float lr ,
...
void update_l4_dens_biases ( float lr ,
...
void update_l5_soft_weights ( float lr ,
...
void update_l5_soft_biases ( float lr ,
