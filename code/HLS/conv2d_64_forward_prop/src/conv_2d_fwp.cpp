...
#pragma HLS DATAFLOW
	...
	hls::stream < float , 3 > gmem_weights_stream[conv2d_64_in_channels];
...
#pragma HLS UNROLL skip_exit_check
		// full convolution
		conv2d < float , conv2d_64_in_height , conv2d_64_in_width ,
			conv2d_64_out_height ,    conv2d_64_out_width ,    conv2d_64_out_channels ,
			conv2d_64_filter_height , conv2d_64_filter_width , conv2d_64_num_filters >
			( conv2d_64_padded_window_stream[in_channel] , gmem_weights_stream[in_channel] , in_channel_map_stream[in_channel] );
	}

	aggregate_channels < conv2d_64_in_height , conv2d_64_in_width , conv2d_64_in_channels , conv2d_64_num_filters >
