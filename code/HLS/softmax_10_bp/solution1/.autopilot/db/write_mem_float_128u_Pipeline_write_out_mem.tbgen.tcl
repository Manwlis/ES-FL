set moduleName write_mem_float_128u_Pipeline_write_out_mem
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {write_mem<float, 128u>_Pipeline_write_out_mem}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 1}  }
	{ sext_ln40 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "gmem_softmax_weights","offset": { "type": "dynamic","port_name": "gmem_softmax_weights","bundle": "control"},"direction": "READONLY"},{"cName": "layer_output","offset": { "type": "dynamic","port_name": "layer_output","bundle": "control"},"direction": "READONLY"},{"cName": "input_error","offset": { "type": "dynamic","port_name": "input_error","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln40", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ softmax_input_error_stream16_dout sc_in sc_lv 32 signal 2 } 
	...
	{ softmax_input_error_stream16_empty_n sc_in sc_logic 1 signal 2 } 
	{ softmax_input_error_stream16_read sc_out sc_logic 1 signal 2 } 
	...
	{ sext_ln40 sc_in sc_lv 58 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln40", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln40", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln40 { ap_none {  { sext_ln40 in_data 0 58 } } }
