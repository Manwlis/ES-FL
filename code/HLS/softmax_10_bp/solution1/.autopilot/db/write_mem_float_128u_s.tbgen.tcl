set moduleName write_mem_float_128u_s
set isTopModule 0
...
set portList { 
	...
	{ softmax_input_error_stream16_dout sc_in sc_lv 32 signal 0 } 
	{ softmax_input_error_stream16_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ softmax_input_error_stream16_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ softmax_input_error_stream16_empty_n sc_in sc_logic 1 signal 0 } 
	{ softmax_input_error_stream16_read sc_out sc_logic 1 signal 0 } 
	...
	{ output_r_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ output_r_fifo_cap sc_in sc_lv 4 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "softmax_input_error_stream16_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "softmax_input_error_stream16", "role": "dout" }} , 
 	...
 	{ "name": "softmax_input_error_stream16_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "softmax_input_error_stream16", "role": "empty_n" }} , 
 	{ "name": "softmax_input_error_stream16_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "softmax_input_error_stream16", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "softmax_input_error_stream16", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_mem_float_128u_Pipeline_write_out_mem_fu_66", "Port" : "softmax_input_error_stream16", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "gmem", "Type" : "MAXI", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "gmem_blk_n_AW", "Type" : "RtlSignal"},
					{"Name" : "gmem_blk_n_B", "Type" : "RtlSignal"}],
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_write_mem_float_128u_Pipeline_write_out_mem_fu_66", "Port" : "gmem", "Inst_start_state" : "3", "Inst_end_state" : "4"}]},
			{"Name" : "output_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "output_r_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_write_mem_float_128u_Pipeline_write_out_mem_fu_66", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_write_mem_float_128u_Pipeline_write_out_mem_fu_66.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	softmax_input_error_stream16 { ap_fifo {  { softmax_input_error_stream16_dout fifo_port_we 0 32 }  { softmax_input_error_stream16_num_data_valid fifo_status_num_data_valid 0 2 }  { softmax_input_error_stream16_fifo_cap fifo_update 0 2 }  { softmax_input_error_stream16_empty_n fifo_status 0 1 }  { softmax_input_error_stream16_read fifo_data 1 1 } } }
	...
	output_r { ap_fifo {  { output_r_dout fifo_port_we 0 64 }  { output_r_num_data_valid fifo_status_num_data_valid 0 4 }  { output_r_fifo_cap fifo_update 0 4 }  { output_r_empty_n fifo_status 0 1 }  { output_r_read fifo_data 1 1 } } }
}
