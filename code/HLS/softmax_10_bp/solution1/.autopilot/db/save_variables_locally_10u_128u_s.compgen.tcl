...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename softmax_weights \
    op interface \
    ports { softmax_weights_address0 { O 7 vector } softmax_weights_ce0 { O 1 bit } softmax_weights_we0 { O 40 vector } softmax_weights_d0 { O 320 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'softmax_weights'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_layer_output \
    op interface \
    ports { layer_output { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { softmax_f_map_stream14_din { O 32 vector } softmax_f_map_stream14_num_data_valid { I 2 vector } softmax_f_map_stream14_fifo_cap { I 2 vector } softmax_f_map_stream14_full_n { I 1 bit } softmax_f_map_stream14_write { O 1 bit } } \
} "
}
