set moduleName save_variables_locally_10u_128u_Pipeline_save_weights_L
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {save_variables_locally<10u, 128u>_Pipeline_save_weights_L}
...
set C_modelArgList {
	...
	{ gmem_softmax_weights_cast int 6 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "softmax_weights", "interface" : "memory", "bitwidth" : 320, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "gmem_softmax_weights_cast", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ softmax_weights_address0 sc_out sc_lv 7 signal 0 } 
	{ softmax_weights_ce0 sc_out sc_logic 1 signal 0 } 
	{ softmax_weights_we0 sc_out sc_lv 40 signal 0 } 
	{ softmax_weights_d0 sc_out sc_lv 320 signal 0 } 
	{ gmem_softmax_weights sc_in sc_lv 64 signal 1 } 
	{ gmem_softmax_weights_cast sc_in sc_lv 6 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gmem_softmax_weights_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "gmem_softmax_weights_cast", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1353", "Max" : "1353"}
...
set Spec2ImplPortList { 
	...
	gmem_softmax_weights_cast { ap_none {  { gmem_softmax_weights_cast in_data 0 6 } } }
}
