...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { softmax_input_error_stream16_dout { I 32 vector } softmax_input_error_stream16_num_data_valid { I 2 vector } softmax_input_error_stream16_fifo_cap { I 2 vector } softmax_input_error_stream16_empty_n { I 1 bit } softmax_input_error_stream16_read { O 1 bit } } \
} "
}
