...
`define AUTOTB_DUT      accel
`define AUTOTB_DUT_INST AESL_inst_accel
`define AUTOTB_TOP      apatb_accel_top
`define AUTOTB_LAT_RESULT_FILE "accel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "accel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_accel_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_gmem_softmax_weights 1
`define AESL_DEPTH_layer_output 1
`define AESL_DEPTH_label_r 1
`define AESL_DEPTH_input_error 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvin_gmem.dat"
`define AUTOTB_TVIN_gmem_softmax_weights_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvin_gmem_softmax_weights.dat"
`define AUTOTB_TVIN_layer_output_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvin_layer_output.dat"
`define AUTOTB_TVIN_label_r_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvin_label_r.dat"
`define AUTOTB_TVIN_input_error_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvin_input_error.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.accel.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.accel.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1668;
parameter LENGTH_gmem_softmax_weights = 1;
parameter LENGTH_layer_output = 1;
parameter LENGTH_label_r = 1;
parameter LENGTH_input_error = 1;
parameter LENGTH_gmem = 89;
...
reg end_gmem_softmax_weights;
reg [31:0] size_gmem_softmax_weights;
reg [31:0] size_gmem_softmax_weights_backup;
reg end_layer_output;
reg [31:0] size_layer_output;
reg [31:0] size_layer_output_backup;
reg end_label_r;
reg [31:0] size_label_r;
reg [31:0] size_label_r_backup;
reg end_input_error;
reg [31:0] size_input_error;
reg [31:0] size_input_error_backup;
