...
#ifndef _accel_dense_biases_RAM_AUTO_1R1W_H_
#define _accel_dense_biases_RAM_AUTO_1R1W_H_

#include <systemc>
#include <iostream>
#include <fstream>

#include "accel_dense_biases_RAM_AUTO_1R1W_memcore.h"

SC_MODULE(accel_dense_biases_RAM_AUTO_1R1W) {
...
protected:
    ...
    accel_dense_biases_RAM_AUTO_1R1W_memcore* accel_dense_biases_RAM_AUTO_1R1W_memcore_U;
...
public:
    ...
    SC_CTOR(accel_dense_biases_RAM_AUTO_1R1W) : m_trace_file(0) {
        SC_METHOD(proc_memcore_addr);
        sensitive << i_address0 << t_address0 << iptr << tptr;

        accel_dense_biases_RAM_AUTO_1R1W_memcore_U = new accel_dense_biases_RAM_AUTO_1R1W_memcore("accel_dense_biases_RAM_AUTO_1R1W_memcore_U");
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->clk      ( clk );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->reset    ( reset );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->ce0      ( i_ce0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->we0      ( i_we0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->address0 ( memcore_iaddr );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->d0       ( i_d0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->q0       ( i_q0 );

        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->ce1      ( t_ce0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->we1      ( t_we0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->address1 ( memcore_taddr );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->d1       ( t_d0 );
        accel_dense_biases_RAM_AUTO_1R1W_memcore_U->q1       ( t_q0 );
        ...
        if (dump_vcd) {
            m_trace_file = sc_create_vcd_trace_file( "accel_dense_biases_RAM_AUTO_1R1W.trace");
            // ports
