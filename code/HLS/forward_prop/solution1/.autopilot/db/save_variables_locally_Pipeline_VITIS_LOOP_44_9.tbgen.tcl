set moduleName save_variables_locally_Pipeline_VITIS_LOOP_44_9
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "softmax_biases", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "trunc_ln18", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ softmax_biases_address0 sc_out sc_lv 4 signal 0 } 
	{ softmax_biases_ce0 sc_out sc_logic 1 signal 0 } 
	{ softmax_biases_we0 sc_out sc_logic 1 signal 0 } 
	{ softmax_biases_d0 sc_out sc_lv 32 signal 0 } 
	{ gmem_softmax_biases sc_in sc_lv 64 signal 1 } 
	{ trunc_ln18 sc_in sc_lv 6 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln18", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "trunc_ln18", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	trunc_ln18 { ap_none {  { trunc_ln18 in_data 0 6 } } }
}
