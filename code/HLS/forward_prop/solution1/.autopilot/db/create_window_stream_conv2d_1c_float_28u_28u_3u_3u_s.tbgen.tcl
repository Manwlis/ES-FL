set moduleName create_window_stream_conv2d_1c_float_28u_28u_3u_3u_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {create_window_stream_conv2d_1c<float, 28u, 28u, 3u, 3u>}
...
set C_modelArgList {
	...
	{ conv2d_32_window_stream int 288 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_stream_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv2d_32_window_stream", "interface" : "fifo", "bitwidth" : 288, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ conv2d_32_window_stream_din sc_out sc_lv 288 signal 4 } 
	{ conv2d_32_window_stream_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ conv2d_32_window_stream_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ conv2d_32_window_stream_full_n sc_in sc_logic 1 signal 4 } 
	{ conv2d_32_window_stream_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv2d_32_window_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":288, "type": "signal", "bundle":{"name": "conv2d_32_window_stream", "role": "din" }} , 
 	...
 	{ "name": "conv2d_32_window_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv2d_32_window_stream", "role": "full_n" }} , 
 	{ "name": "conv2d_32_window_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "conv2d_32_window_stream", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8"],
		"CDFG" : "create_window_stream_conv2d_1c_float_28u_28u_3u_3u_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "conv2d_32_window_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "conv2d_32_window_stream_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "pixel", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2832_32_1_1_U135", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2832_32_1_1_U136", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_2832_32_1_1_U137", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_stream_V_data_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_stream_V_keep_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_stream_V_strb_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_input_stream_V_last_V_U", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	create_window_stream_conv2d_1c_float_28u_28u_3u_3u_s {
		...
		conv2d_32_window_stream {Type O LastRead -1 FirstWrite 1}}}
...
set Spec2ImplPortList { 
	...
	conv2d_32_window_stream { ap_fifo {  { conv2d_32_window_stream_din fifo_port_we 1 288 }  { conv2d_32_window_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { conv2d_32_window_stream_fifo_cap fifo_update 0 3 }  { conv2d_32_window_stream_full_n fifo_status 0 1 }  { conv2d_32_window_stream_write fifo_data 1 1 } } }
}
