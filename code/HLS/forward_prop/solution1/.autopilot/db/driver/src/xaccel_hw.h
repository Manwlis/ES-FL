...
#define XACCEL_CONTROL_ADDR_AP_CTRL                         0x00
#define XACCEL_CONTROL_ADDR_GIE                             0x04
#define XACCEL_CONTROL_ADDR_IER                             0x08
#define XACCEL_CONTROL_ADDR_ISR                             0x0c
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_32_WEIGHTS_DATA     0x10
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_32_WEIGHTS_DATA     64
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_32_BIASES_DATA      0x1c
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_32_BIASES_DATA      64
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_64_WEIGHTS_DATA     0x28
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_64_WEIGHTS_DATA     64
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_64_BIASES_DATA      0x34
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_64_BIASES_DATA      64
#define XACCEL_CONTROL_ADDR_GMEM_DENSE_WEIGHTS_DATA         0x40
#define XACCEL_CONTROL_BITS_GMEM_DENSE_WEIGHTS_DATA         64
#define XACCEL_CONTROL_ADDR_GMEM_DENSE_BIASES_DATA          0x4c
#define XACCEL_CONTROL_BITS_GMEM_DENSE_BIASES_DATA          64
#define XACCEL_CONTROL_ADDR_GMEM_SOFTMAX_WEIGHTS_DATA       0x58
#define XACCEL_CONTROL_BITS_GMEM_SOFTMAX_WEIGHTS_DATA       64
#define XACCEL_CONTROL_ADDR_GMEM_SOFTMAX_BIASES_DATA        0x64
#define XACCEL_CONTROL_BITS_GMEM_SOFTMAX_BIASES_DATA        64
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_32_FEATURE_MAP_DATA 0x70
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_32_FEATURE_MAP_DATA 64
#define XACCEL_CONTROL_ADDR_GMEM_MAXP2D_32_FEATURE_MAP_DATA 0x7c
#define XACCEL_CONTROL_BITS_GMEM_MAXP2D_32_FEATURE_MAP_DATA 64
#define XACCEL_CONTROL_ADDR_GMEM_CONV2D_64_FEATURE_MAP_DATA 0x88
#define XACCEL_CONTROL_BITS_GMEM_CONV2D_64_FEATURE_MAP_DATA 64
#define XACCEL_CONTROL_ADDR_GMEM_MAXP2D_64_FEATURE_MAP_DATA 0x94
#define XACCEL_CONTROL_BITS_GMEM_MAXP2D_64_FEATURE_MAP_DATA 64
#define XACCEL_CONTROL_ADDR_GMEM_DENSE_FEATURE_MAP_DATA     0xa0
#define XACCEL_CONTROL_BITS_GMEM_DENSE_FEATURE_MAP_DATA     64
#define XACCEL_CONTROL_ADDR_GMEM_SOFTMAX_FEATURE_MAP_DATA   0xac
#define XACCEL_CONTROL_BITS_GMEM_SOFTMAX_FEATURE_MAP_DATA   64
