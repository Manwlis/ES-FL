set moduleName softmax_10u_128u_Pipeline_feature_map
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {softmax<10u, 128u>_Pipeline_feature_map}
...
set C_modelArgMapList {[ 
	{ "Name" : "add1827_reload", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "constant_r", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ softmax_f_map_out135_din sc_out sc_lv 32 signal 11 } 
	{ softmax_f_map_out135_num_data_valid sc_in sc_lv 5 signal 11 } 
	{ softmax_f_map_out135_fifo_cap sc_in sc_lv 5 signal 11 } 
	{ softmax_f_map_out135_full_n sc_in sc_logic 1 signal 11 } 
	{ softmax_f_map_out135_write sc_out sc_logic 1 signal 11 } 
	...
	{ constant_r sc_in sc_lv 32 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "constant_r", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "constant_r", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_104_32_1_1_U20424", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	constant_r { ap_none {  { constant_r in_data 0 32 } } }
