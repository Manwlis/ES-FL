...
eval "cg_default_interface_gen_dc { \
    id 20466 \
    name gmem_softmax_feature_map_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_gmem_softmax_feature_map_load \
    op interface \
    ports { gmem_softmax_feature_map_load { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { trunc_ln534_1 { I 6 vector } } \
} "
}
