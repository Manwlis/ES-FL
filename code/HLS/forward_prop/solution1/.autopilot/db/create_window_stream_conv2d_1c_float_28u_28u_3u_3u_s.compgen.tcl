...
set id 135
set name accel_mux_2832_32_1_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { conv2d_32_window_stream_din { O 288 vector } conv2d_32_window_stream_num_data_valid { I 3 vector } conv2d_32_window_stream_fifo_cap { I 3 vector } conv2d_32_window_stream_full_n { I 1 bit } conv2d_32_window_stream_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 144
set RegSliceName accel_regslice_both
set RegSliceInstName accel_regslice_both_U
set CoreName ap_simcore_accel_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
