set moduleName save_variables_locally_Pipeline_VITIS_LOOP_35_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {save_variables_locally_Pipeline_VITIS_LOOP_35_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 0}  }
	{ sext_ln35 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "gmem_conv2d_32_weights","offset": { "type": "dynamic","port_name": "gmem_conv2d_32_weights","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_conv2d_32_biases","offset": { "type": "dynamic","port_name": "gmem_conv2d_32_biases","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_conv2d_64_weights","offset": { "type": "dynamic","port_name": "gmem_conv2d_64_weights","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_conv2d_64_biases","offset": { "type": "dynamic","port_name": "gmem_conv2d_64_biases","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_dense_weights","offset": { "type": "dynamic","port_name": "gmem_dense_weights","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_dense_biases","offset": { "type": "dynamic","port_name": "gmem_dense_biases","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_softmax_weights","offset": { "type": "dynamic","port_name": "gmem_softmax_weights","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_softmax_biases","offset": { "type": "dynamic","port_name": "gmem_softmax_biases","bundle": "control"},"direction": "READONLY"},{"cName": "gmem_conv2d_32_feature_map","offset": { "type": "dynamic","port_name": "gmem_conv2d_32_feature_map","bundle": "control"},"direction": "WRITEONLY"},{"cName": "gmem_maxp2d_32_feature_map","offset": { "type": "dynamic","port_name": "gmem_maxp2d_32_feature_map","bundle": "control"},"direction": "WRITEONLY"},{"cName": "gmem_conv2d_64_feature_map","offset": { "type": "dynamic","port_name": "gmem_conv2d_64_feature_map","bundle": "control"},"direction": "WRITEONLY"},{"cName": "gmem_maxp2d_64_feature_map","offset": { "type": "dynamic","port_name": "gmem_maxp2d_64_feature_map","bundle": "control"},"direction": "WRITEONLY"},{"cName": "gmem_dense_feature_map","offset": { "type": "dynamic","port_name": "gmem_dense_feature_map","bundle": "control"},"direction": "WRITEONLY"},{"cName": "gmem_softmax_feature_map","offset": { "type": "dynamic","port_name": "gmem_softmax_feature_map","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln35", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln35 sc_in sc_lv 58 signal 1 } 
	{ dense_weights_0_address0 sc_out sc_lv 16 signal 2 } 
	{ dense_weights_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ dense_weights_0_we0 sc_out sc_logic 1 signal 2 } 
	{ dense_weights_0_d0 sc_out sc_lv 32 signal 2 } 
	{ dense_weights_1_address0 sc_out sc_lv 16 signal 3 } 
	{ dense_weights_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ dense_weights_1_we0 sc_out sc_logic 1 signal 3 } 
	{ dense_weights_1_d0 sc_out sc_lv 32 signal 3 } 
	{ dense_weights_2_address0 sc_out sc_lv 16 signal 4 } 
	{ dense_weights_2_ce0 sc_out sc_logic 1 signal 4 } 
	{ dense_weights_2_we0 sc_out sc_logic 1 signal 4 } 
	{ dense_weights_2_d0 sc_out sc_lv 32 signal 4 } 
	{ dense_weights_3_address0 sc_out sc_lv 16 signal 5 } 
	{ dense_weights_3_ce0 sc_out sc_logic 1 signal 5 } 
	{ dense_weights_3_we0 sc_out sc_logic 1 signal 5 } 
	{ dense_weights_3_d0 sc_out sc_lv 32 signal 5 } 
	{ dense_weights_4_address0 sc_out sc_lv 16 signal 6 } 
	{ dense_weights_4_ce0 sc_out sc_logic 1 signal 6 } 
	{ dense_weights_4_we0 sc_out sc_logic 1 signal 6 } 
	{ dense_weights_4_d0 sc_out sc_lv 32 signal 6 } 
	{ dense_weights_5_address0 sc_out sc_lv 16 signal 7 } 
	{ dense_weights_5_ce0 sc_out sc_logic 1 signal 7 } 
	{ dense_weights_5_we0 sc_out sc_logic 1 signal 7 } 
	{ dense_weights_5_d0 sc_out sc_lv 32 signal 7 } 
	{ dense_weights_6_address0 sc_out sc_lv 16 signal 8 } 
	{ dense_weights_6_ce0 sc_out sc_logic 1 signal 8 } 
	{ dense_weights_6_we0 sc_out sc_logic 1 signal 8 } 
	{ dense_weights_6_d0 sc_out sc_lv 32 signal 8 } 
	{ dense_weights_7_address0 sc_out sc_lv 16 signal 9 } 
	{ dense_weights_7_ce0 sc_out sc_logic 1 signal 9 } 
	{ dense_weights_7_we0 sc_out sc_logic 1 signal 9 } 
	{ dense_weights_7_d0 sc_out sc_lv 32 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln35", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln35", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "401411", "Max" : "401411"}
	, {"Name" : "Interval", "Min" : "401411", "Max" : "401411"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln35 { ap_none {  { sext_ln35 in_data 0 58 } } }
