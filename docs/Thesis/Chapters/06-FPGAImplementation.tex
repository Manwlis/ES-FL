...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.8\textwidth]{Images/diagrams/pipeline_under_batching.png}
        \decoRule
...
The variable gradients are produced in the first dataflow region and consumed in the second, thus persistent saving in on-chip memory is necessary. The related arrays are not shared since their producers and consumers are in different regions, therefore the number of ports is increased to accomplish the desired data consumption. % gradients
