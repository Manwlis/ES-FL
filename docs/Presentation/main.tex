...
\title[Diploma Thesis]{Reconfigurable Logic (FPGA)-based System Architecture for the Acceleration of Federated Learning in Neural Networks}
...
\include{Chapters/04-FL_architecture_design}
\include{Chapters/05-RobustnessAnalysis}
\include{Chapters/06-FPGAImplementation}
\include{Chapters/07-Results}
\include{Chapters/08-ConclusionsAndFutureWork}
...
\include{Presentation/Chapters/appendix}
